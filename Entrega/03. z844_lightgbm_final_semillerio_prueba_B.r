...
kdataset       <- "./datasets/dataset_8150.csv.gz"
ksemilla_azar  <- 762101  #Aqui poner la propia semilla
ktraining      <- c( 202011,202012,202101 )   #periodos en donde entreno
kfuture        <- c( 202103 )   #periodo donde aplico el modelo final


kexperimento   <- "KA8440_prueba_B"

ksemilla_primos  <-  102191
ksemillerio  <- 100

kmax_bin           <-    31
klearning_rate     <-     0.128736037437592
knum_iterations    <-   712
knum_leaves        <-   560
kmin_data_in_leaf  <-  6838
kfeature_fraction  <-     0.74203654727777
#kmax_depth <- 9 #Esta última linea la agregué yo, según ultima hoja de mi cuaderno
